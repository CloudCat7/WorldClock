...
class WorldClockCoreTest {
    ...
    void EditTime(){
        clocks.editTimes("2018-05-07 10:00:00");
        ...
        assertAll(
                ()->assertEquals("2018-05-07 10:00:00",
                        bjTime.getLocalDateTime().format(
                                DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))),
                ()->assertEquals("2018-05-06 21:00:00",
                        nyTime.getLocalDateTime().format(
                                DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))),
                ()->assertEquals("2018-05-07 02:00:00",
                        ldTime.getLocalDateTime().format(
                                DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))),
                ()->assertEquals("2018-05-07 06:00:00",
                        mscTime.getLocalDateTime().format(
                                DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))),
                ()->assertEquals("2018-05-07 12:00:00",
